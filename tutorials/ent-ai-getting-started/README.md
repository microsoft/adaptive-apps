...
<p align="center">
    <img src="./images/sample-app.png" width="50%" />
</p>
...
| AI Model | Azure OpenAI Service / OpenAI | Azure OpenAI Service / OpenAI / Kaito | Kaito |
| Service-to-Service Auth | mTLS | mTLS | mTLS |
| Policy | Azure Policy | Azure Policy | OPA
