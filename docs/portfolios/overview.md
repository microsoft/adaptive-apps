...
| Agent guardrails | [Agent Governance Toolkit](https://microsoft.github.io/agent-governance-toolkit/) sidecar (image built from `src/agt-sidecar/`) | AGT sidecar | AGT sidecar | AGT sidecar |
